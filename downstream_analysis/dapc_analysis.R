...
dartR::gl2snapp(x = broad_grouping.genlight, outpath=getwd(),
                                 outfile = "populations/mrbayes.nex")
...
StAMPP::stamppPhylip(distance.mat=sample.div, 
                     file="populations/splitstree.txt")
...
ggsave("figures/pca.svg", pca.ggplot, width = 4, dpi=400,
       height = 4, units = "in")
ggsave("figures/pca.png", pca.ggplot, width = 4, dpi=400,
       height = 4, units = "in")
