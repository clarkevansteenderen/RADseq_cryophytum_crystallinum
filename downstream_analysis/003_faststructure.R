...
K2struc.file = "populations/faststructure_output_mac3/fastStructure.2.meanQ"
K3struc.file = "populations/faststructure_output_mac3/fastStructure.3.meanQ"
K4struc.file = "populations/faststructure_output_mac3/fastStructure.4.meanQ"
K5struc.file = "populations/faststructure_output_mac3/fastStructure.5.meanQ"
...
K5 = structure.plot(K5struc.file, sample.info, kval = "5"); K5
K12 = structure.plot(K12struc.file, sample.info, kval = "12"); K12

strucplots = gridExtra::grid.arrange(K2, K3, K4, K5, ncol=1)
ggsave("figures/structureplot.png", strucplots, width = 10, height = 6, units = "in")
ggsave("figures/structureplot_mac3.svg", strucplots, width = 10, height = 9, units = "in")
...
ggsave("figures/hapmap.png", K5hapmap, width = 10, height = 6, units = "in", dpi = 400)
ggsave("figures/hapmap_mac3_K4.svg", K4hapmap, width = 10, height = 6, units = "in", dpi = 400)
